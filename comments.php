 ...
 */
 ...
 // You can start editing here -- including this comment!
	...
	if ( have_comments() ) {
		...
		echo '<div id="comments"> <p>Comments are moderated and generally will be posted if they are on-topic and not abusive.</p><br />';
 ...
 */
 ...
 // Edit comments title and message
 $form_args = array( 'title_reply' => 'Add Your Comments and Join the Conversation' );
 
 comment_form( $form_args );
?>
<p>Comments are moderated and generally will be posted if they are on-topic and not abusive.<br />View our <a href="/atjeff/about-this-blog/commenting-policy/">commenting policy</a>.</p>