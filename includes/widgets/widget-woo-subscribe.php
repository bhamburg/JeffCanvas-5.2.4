	...
	function form ( $instance ) {
        ...
        <p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'single' ); ?>"><?php _e( 'Enable in Posts', 'woothemes' ); ?></label>
	   	</p>
       	...
       	<p>
        	...
        	<label for="<?php echo $this->get_field_id( 'page' ); ?>"><?php _e( 'Enable in Pages', 'woothemes' ); ?></label>
	   	</p>
<?php
	} // End form()
