...
// Check to see if on Keep In Touch or In the News page
if (is_page('kit')) {$args['cat'] = 4;}
if (is_page('in-the-news')) {$args['cat'] = 18;}
// Exclude the "exclude" tag from the homepage
$args['tag__not_in'] = '76';
/////////////////////////////////////////////////////////////////
